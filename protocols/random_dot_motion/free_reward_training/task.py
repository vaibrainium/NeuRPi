...
from protocols.random_dot_motion.free_reward_training.session_manager import (
    SessionManager,
)
from protocols.random_dot_motion.free_reward_training.stimulus_manager import (
    StimulusManager,
)
...
if __name__ == "__main__":
    ...
    current_coherence_level = config.TASK["rolling_performance"][
