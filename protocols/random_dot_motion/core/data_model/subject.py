...
class Subject(BaseSubject):
    ...
    def __init__(
        ...
        super().__init__(session_info.subject_id)
        ...
        self.files = {
            ...
            "event": str(
                Path(self.experiment_dir, self.session, self.id + "_event.csv"),
            ),
            "lick": str(
                Path(self.experiment_dir, self.session, self.id + "_lick.csv"),
            ),
    ...
    def create_summary_plots(self):
        ...
        try:
            ...
            plt.plot(
                experiment_summary["session"].str.split("_").str[0],
                experiment_summary["total_accuracy"],
                "o",
                label="Accuracy vs Training Day",
            )
            ...
            # accuracy vs weigth
            plt.plot(
                experiment_summary["start_weight_prct"],
                experiment_summary["total_accuracy"],
                "o",
                label="Accuracy vs Start Weight",
            )
            ...
            plt.plot(
                experiment_summary["session"].str.split("_").str[0],
                experiment_summary["total_attempt"],
                "o",
                label="Attempts vs Training Day",
            )
            plt.xlabel("Training Day")
            plt.ylabel("Attempts")
            ...
            plt.plot(
                ...
                experiment_summary["total_attempt"],
                "o",
                label="Attempts vs Start Weight",
            )
            plt.xlabel("Start Weight")
            plt.ylabel("Attempts")
