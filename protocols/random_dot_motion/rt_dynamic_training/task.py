...
from protocols.random_dot_motion.rt_dynamic_training.session_manager import SessionManager
from protocols.random_dot_motion.rt_dynamic_training.stimulus_manager import StimulusManager
...
class Task:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.processes = {}
        self.processes["stimulus"] = StimulusManager(stimulus_configuration=config.STIMULUS,
                                                   in_queue=self.msg_to_stimulus,
                                                   out_queue=self.msg_from_stimulus
                                                   )
        self.processes["behavior"] = Behavior(hardware_manager=self.managers["hardware"],
                                             response_block=self.response_block,
