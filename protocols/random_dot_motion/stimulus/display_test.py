...
#################### 2 processes for display and stimulus ####################
...
class DisplayManager:
    ...
    def __init__(self, stimulus_config, in_queue=None, out_queue=None, epoch_update_event=None, stop_event=None):
        ...
        self.buffer_count = 5  # Number of buffers
        self.buffers = None
    ...
    def start(self):
        ...
        self.display_process = multiprocessing.Process(target=self.update_display, daemon=True)
    ...
    def update_display(self):
        while True:
            ...
            # self.screen.fill((255, 255, 255))
                current_surface = self.display_queue.get_nowait()
                self.screen.blit(current_surface, (0,0))
